...
namespace GESTIONESCOLAR
{
  ...
  private String _curSeccion;
            public String curSeccion { get { return _curSeccion; } set { _curSeccion = value; } }
            ...
            public Curso(Int32 curId)
            {
                try
                {
                    ...
                    if (Fila.Rows.Count > 0)
                    {
                        ...
                        if (Fila.Rows[0]["curSeccion"].ToString().Trim().Length > 0)
                        {
                            this.curSeccion = Convert.ToString(Fila.Rows[0]["curSeccion"]);
                        }
                        else
                        {
                            this.curSeccion = "";
            ...
            public Curso(Int32 curId, String curNombre,String curSeccion, Boolean curActivo, DateTime curFechaHoraCreacion, DateTime curFechaHoraUltimaModificacion, Int32 IplaId, Int32 IusuIdCreacion, Int32 IusuIdUltimaModificacion)
            {
                try
                {
                    this.curId = curId;
                    this.curNombre = curNombre;
 this.curSeccion = curSeccion;
    ...
    public DataTable ObtenerListaPorCarId(String PrimerItem, Int32 carId)
            {
                ocdGestor = new Datos.Gestor();
                Tabla = new DataTable();
                ...
                try
                {
                    Tabla = ocdGestor.EjecutarReader("[Curso.ObtenerListaPorCarId]", new object[,] { { "@PrimerItem", PrimerItem }, { "@carId", carId } });
                }
                catch (Exception oError)
                {
                    throw oError;
      ...
      public DataTable ObtenerTodoBuscarxNombrexPlaId(String Nombre, Int32 plaId)
            {
                ocdGestor = new Datos.Gestor();
                Tabla = new DataTable();
                ...
                try
                {
                    Tabla = ocdGestor.EjecutarReader("[Curso.ObtenerTodoBuscarxNombrexPlaId]", new object[,] { { "@Nombre", Nombre },{ "@plaId", plaId } });
                }
                catch (Exception oError)
                {
                    throw oError;
            ...
            public void Actualizar()
            {
                try
                {
                    if (this.curId != 0)
                    {
                        ocdGestor.EjecutarNonQuery("[Curso.Actualizar]", new object[,] { { "@curId", curId }, { "@curNombre", curNombre }, { "@plaId", plaId }, { "@curSeccion", curSeccion }, { "@curActivo", curActivo }, { "@usuIdCreacion", usuIdCreacion }, { "@usuIdUltimaModificacion", usuIdUltimaModificacion }, { "@curFechaHoraCreacion", curFechaHoraCreacion }, { "@curFechaHoraUltimaModificacion", curFechaHoraUltimaModificacion } });
                    }
                }
                catch (Exception oError)
                {
            ...
            public Int32 Insertar()
            {
                ...
                try
                {
                    IdMax = ocdGestor.EjecutarNonQueryRetornaId("[Curso.Insertar]", new object[,] { { "@curNombre", curNombre },{ "@plaId", plaId }, { "@curSeccion", curSeccion }, { "@curActivo", curActivo }, { "@usuIdCreacion", usuIdCreacion }, { "@usuIdUltimaModificacion", usuIdUltimaModificacion }, { "@curFechaHoraCreacion", curFechaHoraCreacion }, { "@curFechaHoraUltimaModificacion", curFechaHoraUltimaModificacion } });
                }
                catch (Exception oError)
                {
                    throw oError;
