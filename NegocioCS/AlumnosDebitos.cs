...
namespace GESTIONESCOLAR
{
    namespace Negocio
    {
        public partial class AlumnosDebitos
        {
            ...
            public DataTable ObtenerAlumnosxDocparaActivar(Int32 aluid)
            {
                ocdGestor = new Datos.Gestor();
                Tabla = new DataTable();
                ...
                try
                {
                    Tabla = ocdGestor.EjecutarReader("[AlumnosDebitos.ObtenerAlumnosxDocparaActivar]", new object[,] { { "@aluid", aluid } });
                }
                catch (Exception oError)
                {
                    throw oError;
            ...
            public void Activar()
            {
                try
                {
                    if (this.adeId != 0)
                    {
                        ocdGestor.EjecutarNonQuery("[AlumnosDebitos.Activar]", new object[,] { { "@adeId", adeId } });
                    }
                }
                catch (Exception oError)
                {
