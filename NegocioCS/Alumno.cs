    ...
    namespace Negocio
    {
        public partial class Alumno
        {
            ...
            public Int32 Insertar()
            {
                ...
                try
                {
                    IdMax = ocdGestor.EjecutarNonQueryRetornaId("[Alumno.Insertar]", new object[,] {{ "@aluNombre", aluNombre }, { "@aluDoc", aluDoc }, { "@aluCuit", aluCuit }, { "@aluLegajoNumero", aluLegajoNumero },
                        { "@aluDomicilio", aluDomicilio }, { "@aluDepto", aluDepto }, { "@aluFechaNacimiento", aluFechaNacimiento },
                        { "@aluPaisNac", aluPaisNac }, { "@aluProvNac", aluProvNac }, { "@aluDeptoNac", aluDeptoNac }, { "@aluLocNac", aluLocNac }
                        , { "@sexId", sexId }, { "@aluMail", aluMail }, { "@aluTelefono", aluTelefono }, { "@aluTelefonoCel", aluTelefonoCel },
                        { "@aluActivo", aluActivo }, { "@usuIdCreacion", usuIdCreacion }, { "@usuIdUltimaModificacion", usuIdUltimaModificacion }
                        , { "@aluFechaHoraCreacion", aluFechaHoraCreacion }, { "@aluFechaHoraUltimaModificacion", aluFechaHoraUltimaModificacion }
                        , { "@gsaId", gsaId }, { "@aluTelUrgencias", aluTelUrgencias }, { "@aluDomFliar", aluDomFliar }, { "@aluPreg1", aluPreg1 }
                        ,{ "@aluPreg2", aluPreg2 }, { "@aluPreg3", aluPreg3 }, { "@aluPreg4", aluPreg4 }, { "@aluPreg5", aluPreg5 },
                        { "@aluPreg6", aluPreg6 }, { "@aluPreg7", aluPreg7 }, { "@aluAclara", aluAclara } });
                }
                catch (Exception oError)
                {
                    throw oError;
