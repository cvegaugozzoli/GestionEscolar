...
namespace GESTIONESCOLAR
{
    namespace Negocio
    {
        public partial class  Perfil
        {
            ...
            public DataTable ObtenerListaxusuId(String PrimerItem, int usuId)
            {
                ocdGestor = new Datos.Gestor();
                Tabla = new DataTable();
                ...
                try
                {
                    Tabla = ocdGestor.EjecutarReader("[Perfil.ObtenerListaxusuId]", new object[,] { { "@PrimerItem", PrimerItem }, { "@usuId", usuId } });
                }
                catch (Exception oError)
                {
                    throw oError;
            ...
            public DataTable ObtenerLista(String PrimerItem)
            {
             ...
             public DataTable ObtenerListaDocente(String PrimerItem)
            {
                ocdGestor = new Datos.Gestor();
                Tabla = new DataTable();
                ...
                try
                {
                	Tabla = ocdGestor.EjecutarReader("[Perfil.ObtenerListaDocente]", new object[,] {{"@PrimerItem", PrimerItem}});
                }
                catch (Exception oError)
                {
                	throw oError;
