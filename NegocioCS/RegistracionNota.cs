...
namespace GESTIONESCOLAR
{
    namespace Negocio
    {
        public partial class RegistracionNota
        {
            ...
            private String _renPromAnual;
            public String renPromAnual { get { return _renPromAnual; } set { _renPromAnual = value; } }
            ...
            private String _renExamenAdic;
            public String renExamenAdic { get { return _renExamenAdic; } set { _renExamenAdic = value; } }

            private String _renObservaciones;
            public String renObservaciones { get { return _renObservaciones; } set { _renObservaciones = value; } }

            private Boolean _renActivo;
            public Boolean renActivo { get { return _renActivo; } set { _renActivo = value; } }
            ...
            public RegistracionNota(Int32 renId)
            {
                try
                {
                    ...
                    if (Fila.Rows.Count > 0)
                    {
                        ...
                        if (Fila.Rows[0]["renExamenAdic"].ToString().Trim().Length > 0)
                        {
                            this.renExamenAdic = Convert.ToString(Fila.Rows[0]["renExamenAdic"]);
                        }
                        else
                        {
                            this.renExamenAdic = "";
                        ...
                        if (Fila.Rows[0]["renPromAnual"].ToString().Trim().Length > 0)
                        {
                            this.renPromAnual = Convert.ToString(Fila.Rows[0]["renPromAnual"]);
                        }
                        else
                        {
                            this.renPromAnual = "";
                        ...
                        if (Fila.Rows[0]["renActivo"].ToString().Trim().Length > 0)
                        {
                            this.renActivo = (Convert.ToInt32(Fila.Rows[0]["regActivo"]) == 1 ? true : false);
                        }
                        else
                        {
                            this.renActivo = false;
                        }
                    }
                }
            ...
            public RegistracionNota(Int32 renId, Int32 icuId, Int32 escId, String renPCuat, String renSCuat, String renPTrim, String renSTrim, String renTTrim, String renDic, String renPromAnual, String renMar, String renCalfDef, String renEvaluacionFinal, String renObservaciones, bool renActivo, DateTime renFechaHoraCreacion, DateTime renFechaHoraUltimaModificacion, Int32 IusuIdCreacion, Int32 IusuIdUltimaModificacion, String renExamenAdic)
            {
                try
                {
                    this.renId = renId;
                    ...
                    this.renActivo = renActivo;
                    this.renPromAnual = renPromAnual;
                    this.renExamenAdic = renExamenAdic;
            ...
            public DataTable ObtenerTodoporEspCurricularAnio(Int32 espId, Int32 curId, Int32 anio, Int32 insId)
            {
                ocdGestor = new Datos.Gestor();
                Tabla = new DataTable();
                ...
                try
                {
                    Tabla = ocdGestor.EjecutarReader("[RegistracionNota.ObtenerTodoporEspCurricularAnio]", new object[,] { { "@espId", espId }, { "@curId", curId }, { "@anio", anio }, { "@insId", insId } });
                }
                catch (Exception oError)
                {
                    throw oError;
            ...
            public void AsignarNotaExamenAdic(Int32 renId, String renExamenAdic)
            {
                try
                {
                    ocdGestor.EjecutarNonQuery("[RegistracionNota.AsignarNotaExamenAdic]", new object[,] { { "@renId", renId }, { "@renExamenAdic", renExamenAdic } });
                }
                catch (Exception oError)
                {
                    throw oError;
            ...
            public void Insertar(Int32 icuId, Int32 escId, Int32 renActivo, Int32 usuIdCreacion, Int32 usuIdUltimaModificacion, DateTime renFechaHoraCreacion, DateTime renFechaHoraUltimaModificacion)
            {
                try
                {
                    ocdGestor.EjecutarNonQuery("[RegistracionNota.Insertar]", new object[,] { { "@icuId", icuId }, { "@escId", escId }, { "@renActivo", renActivo }, { "@usuIdCreacion", usuIdCreacion }, { "@usuIdUltimaModificacion", usuIdUltimaModificacion }, { "@renFechaHoraCreacion", renFechaHoraCreacion }, { "@renFechaHoraUltimaModificacion", renFechaHoraUltimaModificacion }, });
                }
                catch (Exception oError)
                {
                    throw oError;
            ...
            public void Actualizar()
            {
                try
                {
                    if (this.renId != 0)
                    {
                        ocdGestor.EjecutarNonQuery("[RegistracionNota.Actualizar]", new object[,] { { "@renId", renId }, { "@icuId", icuId }, { "@escId", escId }, { "@renPCuat", renPCuat }, { "@renSCuat", renSCuat }, { "@renPTrim", renPTrim }, { "@renSTrim", renSTrim }, { "@renTTrim", renTTrim }, { "@renDic", renDic }, { "@renCalfDef", renCalfDef }, { "@renActivo", renActivo }, { "@renEvaluacionFinal", renEvaluacionFinal }, { "@renObservaciones", renObservaciones }, { "@usuIdCreacion", usuIdCreacion }, { "@usuIdUltimaModificacion", usuIdUltimaModificacion }, { "@renFechaHoraCreacion", renFechaHoraCreacion }, { "@renFechaHoraUltimaModificacion", renFechaHoraUltimaModificacion } });
                    }
                }
                catch (Exception oError)
                {
            ...
            public void ActualizarActivoPorIcuId(Int32 icuId, Int32 usuIdCreacion, DateTime renFechaHoraUltimaModificacion)
            {
                try
                {
                 
                        ocdGestor.EjecutarNonQuery("[RegistracionNota.ActualizarActivoPorIcuId]", new object[,] { { "@icuId", icuId }, { "@usuIdUltimaModificacion", usuIdUltimaModificacion }, { "@renFechaHoraUltimaModificacion", renFechaHoraUltimaModificacion } });
            ...
            public Int32 Insertar()
            {
                ...
                try
                {
                    IdMax = ocdGestor.EjecutarNonQueryRetornaId("[RegistracionNota.Insertar]", new object[,] { { "@icuId", icuId }, { "@escId", escId }, { "@renPCuat", renPCuat }, { "@renSCuat", renSCuat }, { "@renPTrim", renPTrim }, { "@renSTrim", renSTrim }, { "@renTTrim", renTTrim }, { "@renDic", renDic }, { "@renCalfDef", renCalfDef }, { "@renEvaluacionFinal", renEvaluacionFinal }, { "@renObservaciones", renObservaciones }, { "@renActivo", renActivo }, { "@usuIdCreacion", usuIdCreacion }, { "@usuIdUltimaModificacion", usuIdUltimaModificacion }, { "@renFechaHoraCreacion", renFechaHoraCreacion }, { "@renFechaHoraUltimaModificacion", renFechaHoraUltimaModificacion } });
                }
                catch (Exception oError)
                {
                    throw oError;
