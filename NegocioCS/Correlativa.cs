...
namespace GESTIONESCOLAR
{
    namespace Negocio
    {
        public partial class Correlativa
        {
            ...
            public DataTable ObtenerxcurIdxescIdxcotId(Int32 curId, Int32 escId)
            {
                ocdGestor = new Datos.Gestor();
                Tabla = new DataTable();
                ...
                try
                {
                    Tabla = ocdGestor.EjecutarReader("[Correlativa.ObtenerxcurIdxescIdxcotId]", new object[,] { { "@curId", curId }, { "@escId", escId } });
                }
                catch (Exception oError)
                {
                    throw oError;
            ...
            public DataTable ObtenerxcarIdxcurIdxescIdxcotId(Int32 carId, Int32 plaId, Int32 curId, Int32 escId, Int32 cotId, Int32 inst)
            {
                ocdGestor = new Datos.Gestor();
                Tabla = new DataTable();
                ...
                try
                {
                    Tabla = ocdGestor.EjecutarReader("[Correlativa.ObtenerxcarIdxcurIdxescIdxcotId]", new object[,] { { "@carId", carId }, { "@plaId", plaId }, { "@curId", curId }, { "@escId", escId }, { "@cotId", cotId }, { "@inst", inst } });
                }
                catch (Exception oError)
                {
                    throw oError;
            ...
            public void EliminarxescCorr(Int32 escId)
            {
                try
                {
                    ocdGestor.EjecutarNonQuery("[Correlativa.EliminarxescCorr]", new object[,] { { "@escId", escId } });
                }
                catch (Exception oError)
                {
                    throw oError;
