    ...
    namespace Negocio
    {
        public partial class  Instituciones
        {
              ...
              public DataTable ObtenerListaxusuId(String PrimerItem, Int32 usuId)
            {
                ...
                try
                {
                	Tabla = ocdGestor.EjecutarReader("[Instituciones.ObtenerListaxusuId]", new object[,] {{"@PrimerItem", PrimerItem},{ "@usuId", usuId } });
                }
                catch (Exception oError)
                {
                	throw oError;
            ...
            public DataTable ObtenerTodoxusuId( Int32 usuId)
            {
                ocdGestor = new Datos.Gestor();
                Tabla = new DataTable();
                ...
                try
                {
                	Tabla = ocdGestor.EjecutarReader("[Instituciones.ObtenerTodoxusuId]", new object[,] {{ "@usuId", usuId } });
                }
                catch (Exception oError)
                {
                	throw oError;
