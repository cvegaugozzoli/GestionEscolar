...
namespace GESTIONESCOLAR
{
    namespace Negocio
    {
        public partial class PlanEstudio
        {
            ...
            public DataTable ObtenerTodoBuscarxCarrera(int carId)
            {
                ocdGestor = new Datos.Gestor();
                Tabla = new DataTable();
                ...
                try
                {
                    Tabla = ocdGestor.EjecutarReader("[PlanEstudio.ObtenerTodoBuscarxCarrera]", new object[,] { { "@carId", carId } });
                }
                catch (Exception oError)
                {
                    throw oError;
            ...
            public DataTable ObtenerUltxCarId(int carId)
            {
                ocdGestor = new Datos.Gestor();
                Tabla = new DataTable();
                ...
                try
                {
                    Tabla = ocdGestor.EjecutarReader("[PlanEstudio.ObtenerUltxCarId]", new object[,] { { "@carId", carId } });
                }
                catch (Exception oError)
                {
                    throw oError;
            ...
            public DataTable ObtenerListaPorUnaCarreraParaPreInscripcion(String PrimerItem, Int32 carId)
            {
                ocdGestor = new Datos.Gestor();
                Tabla = new DataTable();
                ...
                try
                {
                    Tabla = ocdGestor.EjecutarReader("[PlanEstudio.ObtenerListaPorUnaCarreraParaPreInscripcion]", new object[,] { { "@PrimerItem", PrimerItem }, { "@carId", carId } });
                }
                catch (Exception oError)
                {
                    throw oError;
