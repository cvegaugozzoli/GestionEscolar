    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                this.Master.TituloDelFormulario = "Registro de Matriculas";
                ...
                ddlTipoConc.DataValueField = "Valor";
                ddlTipoConc.DataTextField = "Texto";
                ddlTipoConc.DataSource = (new GESTIONESCOLAR.Negocio.ConceptosTipos()).ObtenerListaInscripcion("[Seleccionar...]");
                ddlTipoConc.DataBind();
                ddlTipoConc.SelectedIndex= 2;
                //ddlTipoConc.Enabled = false;
...
MESSAGE:<br>" + oError.Message + "<br><br>EXCEPTION:<br>" + oError.InnerException + "<br><br>TRACE:<br>" + oError.StackTrace + "<br><br>TARGET:<br>" + oError.TargetSite +
    ...
    protected void btnImprimir_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Convert.ToInt32(RbtSeleccion.SelectedValue) == 1)
            {                              
                    NomRep = "RegistroMatriculas.rpt";               
            }
            else
            {               
                    NomRep = "RegistroMatriculasBecados.rpt";               
            }
