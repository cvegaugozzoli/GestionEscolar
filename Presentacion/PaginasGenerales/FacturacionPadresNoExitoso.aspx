<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="FacturacionPadresNoExitoso.aspx.cs" Inherits="FacturacionPadresNoExitoso" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
    ...
    <div class="row">
        <div class="form-group">
            <asp:Label ID="lblMensajeError" runat="server" Text="mensaje de error"></asp:Label>
    ...
    <div class="form-group">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-row">
                    <asp:Label ID="Label4" runat="server" Text="hash.." Visible="true"></asp:Label><br /><br />
                    <asp:Label ID="Label5" runat="server" Text="idResultado.." Visible="true"><br /><br /></asp:Label><br /><br />
                    <asp:Label ID="Label6" runat="server" Text="json.." Visible="true"></asp:Label><br /><br />
                    <asp:Label ID="Label7" runat="server" Text="json.." Visible="true"></asp:Label><br /><br />
                    <asp:Label ID="Label8" runat="server" Text="json.." Visible="true"></asp:Label><br /><br />
                    <asp:Label ID="Label9" runat="server" Text="URL" Visible="true"></asp:Label><br /><br />
                </div>
    ...
    <div class="row">
        <div class="ibox-content">
            <div class="form-inline">
                ...
                <asp:TextBox ID="TextDescuento" type="DateTimePicker" class="form-control" runat="server" BorderColor="Silver"></asp:TextBox>
                <asp:CheckBox ID="chkDesc" class="form-check-input" runat="server" OnCheckedChanged="chkDesc_CheckedChanged"
                    AutoPostBack="true" />
                <label class="form-check-label">Aplicar Descuento&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label>


                &nbsp;<asp:CheckBox ID="CheckDctoSacar" class="form-check-input" runat="server" OnCheckedChanged="CheckDctoSacar_CheckedChanged"
                    AutoPostBack="true" />
                <label class="form-check-label">Sacar Descuentos</label>
            </div>
            <br />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="panel-group" id="accordion">
                                                ...
                                                <div class="panel panel-info">
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Cheque</a>
                                                        </h4>
                                                    </div>
                                                    <div id="collapse3" class="panel-collapse collapse">
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                <asp:Label ID="lblNroCheque" class="control-label" runat="server">Numero de Cheque</asp:Label>
