    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    //lblMensaje.Text = "Parámetros incompletos.";
                }
                ////
...
MESSAGE:<br>" + oError.Message + "<br><br>EXCEPTION:<br>" + oError.InnerException + "<br><br>TRACE:<br>" + oError.StackTrace + "<br><br>TARGET:<br>" + oError.TargetSite +
    ...
    private string InicioSesion()
    {
        ...
        // URL del endpoint de SIRO y credenciales básicas
        //string baseUrl = "https://api.onlinesiro.com.ar/boton-pagos"; // Endpoint para crear el botón de pago
    ...
    private string RealizarPago(string bearerTokenOrigen)
    {
        ...
        var payload = new
        {
            ...
            URL_ERROR = "https://www.google.com/",   // Poner una página de Error de la Obra
