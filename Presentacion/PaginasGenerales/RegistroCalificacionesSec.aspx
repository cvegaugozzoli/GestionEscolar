<%@ Page EnableEventValidation="true" Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="RegistroCalificacionesSec.aspx.cs" Inherits="RegistroCalificacionesSec" %>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <asp:DropDownList ID="PeriodoId" requeried="" runat="server" class="form-control m-b" Enabled="true" AutoPostBack="true" BorderColor="Silver" OnSelectedIndexChanged="PeriodoId_SelectedIndexChanged">
                                    ...
                                    <asp:ListItem Value="8">1° Cuatrimestre</asp:ListItem>
                                    <asp:ListItem Value="9">2° Cuatrimestre</asp:ListItem>
