...
"</div>";
    ...
    protected void aluNombre_textChanged(object sender, EventArgs e)
    {
        ...
        string texto = aluNombre.Text;

        // Convertir el texto a mayúsculas
        string textoEnMayusculas = texto.ToUpper();

        // Asignar el texto en mayúsculas de nuevo al TextBox
        // Importante: Evita el bucle infinito al cambiar el texto dentro del evento TextChanged
        if (aluNombre.Text != textoEnMayusculas)
        {
            aluNombre.Text = textoEnMayusculas;
...
MESSAGE:<br>" + oError.Message + "<br><br>EXCEPTION:<br>" + oError.InnerException + "<br><br>TRACE:<br>" + oError.StackTrace + "<br><br>TARGET:<br>" + oError.TargetSite +
    ...
    protected void btnAceptar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            int aluId2 = 0;
            //dt5 = new DataTable();
            //dt5 = ocnAlumno.ObtenerUnoporDoc(aluDoc.Text.Trim());
            ...
            if (DniMadre.Text != "")
            {
                ...
                if (dt.Rows.Count > 0)//existe Madre en Familiar
                {
                    ...
                    int afaIdAlumnoFamiliar = ocnAlumnoFamiliar.ObtenerUnoAfaId(aluId2, DniMadre.Text.Trim());
                    ...
                    {
                        //ocnAlumnoFamiliar = new GESTIONESCOLAR.Negocio.AlumnoFamiliar(FamIdAlumnoFamiliar);
                        ocnAlumnoFamiliar = new GESTIONESCOLAR.Negocio.AlumnoFamiliar(afaIdAlumnoFamiliar);
                        //ocnAlumnoFamiliar.usuIdUltimaModificacion = this.Master.usuId;
                        ocnAlumnoFamiliar.afaFechaHoraUltimaModificacion = DateTime.Today;
...
MESSAGE:<br>" + oError.Message + "<br><br>EXCEPTION:<br>" + oError.InnerException + "<br><br>TRACE:<br>" + oError.StackTrace + "<br><br>TARGET:<br>" + oError.TargetSite +
    ...
    protected void paisId_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                provinciaId.SelectedValue = "0";
                DepartamentoNac.SelectedValue = "0";
                LocalidadId.SelectedValue = "0";
    ...
    protected void btnLimpiarAlumno_Click(object sender, EventArgs e)
    {
        ...
        this.aluDoc.Text = "";
        this.aluCuit.Text = "";
        this.aluLegajoNumero.Text = "";
        this.aluDomicilio.Text = "";
        this.DepartamentoId.SelectedValue = "0";
        this.aluFechaNacimiento.Text = DateTime.Now;
        this.paisId.SelectedValue = "0";
        //this.provinciaId.SelectedValue = Convert.ToString(ocnAlumno.aluProvNac);
        //this.DepartamentoNac.SelectedValue = Convert.ToString(ocnAlumno.aluDeptoNac);
        //this.LocalidadId.SelectedValue = Convert.ToString(ocnAlumno.aluLocNac);
        this.aluMail.Text = "";
        this.aluTelefono.Text = "";
        this.aluActivo.Checked = true;
        this.aluTelCel.Text = "";

        this.sexId.SelectedValue = "0";
    }
}