...
public partial class InformeVencidos : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                this.Master.TituloDelFormulario = " Informe de Vencidos";
                ...
                //txthasta.text = fechaActual.Date.ToString() ;    //DateTime.Today.ToShortDateString;


                #region PageIndex
                int PageIndex = 0;

                if (this.Session["InformeVencidos.PageIndex"] == null)
                {
                    Session.Add("InformeVencidos.PageIndex", 0);
                }
                else
                {
                    PageIndex = Convert.ToInt32(Session["InformeVencidos.PageIndex"]);
                }
                #endregion
...
MESSAGE:<br>" + oError.Message + "<br><br>EXCEPTION:<br>" + oError.InnerException + "<br><br>TRACE:<br>" + oError.StackTrace + "<br><br>TARGET:<br>" + oError.TargetSite +
    ...
    protected void btnImprimir_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                NomRep = "ListadoVencidosBecados.rpt";
            }
