                                ...
                                <asp:GridView ID="GrillaNota" runat="server" CssClass="table table-striped"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Alumno" ItemStyle-Width="250" ItemStyle-VerticalAlign="Bottom">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="lblAlumno" runat="server" NavigateUrl='<%# "CargaCalificacionesPorAlumnoPri.aspx?icuId=" + DataBinder.Eval(Container.DataItem,"InscripcionCursado").ToString() %>' Text='<%# Eval("aluNombre") %>' Width="250"></asp:HyperLink>
                                            </ItemTemplate>
                                            <ItemStyle Font-Bold="True" Width="250px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Calificación Final" ItemStyle-Width="100">
                                            <ItemTemplate>
