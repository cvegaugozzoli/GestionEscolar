<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="ConceptosGenerados.aspx.cs" Inherits="ConceptosGenerados" %>
                        ...
                        <div class="row">
                            ...
                            <div class="form-row" style="background-color: #FFFFFF">
                                <div class="form-group col-md-2">
                                    ...
                                    <asp:TextBox ID="AnioCursado" runat="server" type="text" class="form-control m-b" AutoPostBack="true" ></asp:TextBox>
                                </div>
                ...
                <div class="table-responsive">
                    <asp:GridView ID="Grilla" runat="server" GridLines="None" CssClass="table table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Nombre">
                                <ItemTemplate>
                                    <asp:HyperLink ForeColor="Black" ID="HyperLink11" runat="server" Text='<%# Eval("Conceptos") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
