...
public partial class PresInscripcionVarios : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                Session["Bandera"] = 0;
                lblicuId.Text = "";
                this.Master.TituloDelFormulario = " PreInscripciones - Registracion";
                insId = Convert.ToInt32(Session["_Institucion"]);
                int nivid = 0;
                //nivid = Convert.ToInt32(Session["_UsuNivId"]);
                ...
                #region PageIndex
                int PageIndex = 0;
                if (this.Session["PreInscripcionVarios.PageIndex"] == null)
                {
                    Session.Add("PreInscripcionVarios.PageIndex", 0);
                }
                else
                {
                    PageIndex = Convert.ToInt32(Session["PreInscripcionVarios.PageIndex"]);
                }
                #endregion
                ...
                if (Request.QueryString["Id"] != null)
                {
                    ...
                    {
                        NivelID.DataSource = (new GESTIONESCOLAR.Negocio.InstitucionNivel()).ObtenerListaxInsxNivel("[Seleccionar...]", insId, nivid);
                    }
                    NivelID.DataBind();
...
"</div>";
    ...
    private void GrillaCargar(int PageIndex)
    {
        ...
        {
            CanReg.Visible = false;
            Session["PreInscripcionVarios.PageIndex"] = PageIndex;
        ...
        try
        {
            if (e.CommandName != "Sort" && e.CommandName != "Page" && e.CommandName != "")
            {
                ...
                if (e.CommandName == "Select")
                {
                    ...
                    aluId.Text = Id;
                    aluFechaNacimiento.Text = ((HyperLink)Grilla.Rows[Convert.ToInt32(e.CommandArgument)].Cells[6].Controls[1]).Text;
                    CanReg.Visible = false;
...
"</div>";
    ...
    protected void Grilla_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        try
        {
            if (Session["PreInscripcionVarios.PageIndex"] != null)
            {
                Session["PreInscripcionVarios.PageIndex"] = e.NewPageIndex;
            }
            else
            {
                Session.Add("PreInscripcionVarios.PageIndex", e.NewPageIndex);
            }
...
"</div>";
    ...
    protected void btnInscribir_Click(object sender, EventArgs e)
    {
        try
        {
            alerError2.Visible = false; alerError2.Visible = false;
            alerErrorConcepto.Visible = false;
            ...
            if (Request.QueryString["Id"] != null)
            {
                ...
                {
                    DataTable dtMismoAnio = new DataTable();
                    dtMismoAnio = ocnInscripcionCursado.ObtenerUnoControlExisteMismoAño(insId, Convert.ToInt32(aluId.Text.Trim().ToString()), Convert.ToInt32(icuAnioCursado.Text.Trim().ToString()));

                    if (dtMismoAnio.Rows.Count > 0) // Está en otro cueso mismo año?
                    {
                        alerError2.Visible = true;
                        lblError2.Text = string.Format("El alumno: {1}  se encuentra inscripto en el curso: {0} para ese mismo año", Convert.ToString(dtMismoAnio.Rows[0]["Curso"]), Convert.ToString(dtMismoAnio.Rows[0]["Alumno"]));
                    }
                    ...
                    else
                    {
                        ...
                        if (ControlFaltaCorrelativa == 0)  // Si estan bien las correlativas Inserto Ins. Cursado
                        {
                            ...
                            ocnInscripcionCursado.icuInsConfirmar = 0;
...
"</div>";
    ...
    protected void carId_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            plaId.DataSource = (new GESTIONESCOLAR.Negocio.PlanEstudio()).ObtenerListaPorUnaCarreraParaPreInscripcion("[Seleccionar...]", Convert.ToInt32(carId.SelectedValue));
            plaId.DataBind();
            plaId.Enabled = true;
        }
    }
    ...
    protected void btnCompbtePreInscripcion_Click(object sender, EventArgs e)
    {
        insId = Convert.ToInt32(Session["_Institucion"]);
        String NomRep = "";
        Int32 alumnoId = Convert.ToInt32(aluId.Text);
        Int32 curso = Convert.ToInt32(curId.SelectedValue);
        Int32 anio = Convert.ToInt32(icuAnioCursado.Text.Trim());

        if (insId == 1 && (Convert.ToInt32(curId.SelectedValue) == 68 || Convert.ToInt32(curId.SelectedValue) == 77 || Convert.ToInt32(curId.SelectedValue) == 81 || Convert.ToInt32(curId.SelectedValue) == 118)) //Si es San José
        {
            NomRep = "InformeConstanciaPreinscripcionSanJose.rpt";
        }
        else
        {
            if (insId == 2 && (Convert.ToInt32(curId.SelectedValue) == 68 || Convert.ToInt32(curId.SelectedValue) == 77 || Convert.ToInt32(curId.SelectedValue) == 81 || Convert.ToInt32(curId.SelectedValue) == 118)) //Si es Misericordia
            {
                NomRep = "InformeConstanciaPreinscripcionMisericordia.rpt";
            }
            else
            {
                if (insId == 3 && (Convert.ToInt32(curId.SelectedValue) == 68 || Convert.ToInt32(curId.SelectedValue) == 77 || Convert.ToInt32(curId.SelectedValue) == 81 || Convert.ToInt32(curId.SelectedValue) == 118)) //Si es San Vicente
                {
                    NomRep = "InformeConstanciaPreinscripcionSanVicente.rpt";
                }
                else
                {
                    if (insId == 4 && (Convert.ToInt32(curId.SelectedValue) == 56 || Convert.ToInt32(curId.SelectedValue) == 57 || Convert.ToInt32(curId.SelectedValue) == 58 || Convert.ToInt32(curId.SelectedValue) == 59)) //Si es Jardin Misericordia, sala 3
                    {
                        NomRep = "InformeConstanciaPreinscripcionJardinMisericordia.rpt";
                    }
                    else
                    {
                        if (insId == 4 && (Convert.ToInt32(curId.SelectedValue) == 60 || Convert.ToInt32(curId.SelectedValue) == 61 || Convert.ToInt32(curId.SelectedValue) == 62 || Convert.ToInt32(curId.SelectedValue) == 63))
                        {
                            NomRep = "InformeConstanciaPreinscripcionJardinMisericordia.rpt";
                        }
                        else
                        {
                            if (insId == 4 && (Convert.ToInt32(curId.SelectedValue) == 171 || Convert.ToInt32(curId.SelectedValue) == 172 || Convert.ToInt32(curId.SelectedValue) == 173 || Convert.ToInt32(curId.SelectedValue) == 174))
                            {
                                NomRep = "InformeConstanciaPreinscripcionJardinMisericordia.rpt";
                            }
                            else
                            {
                                if (insId == 5 && (Convert.ToInt32(curId.SelectedValue) == 56 || Convert.ToInt32(curId.SelectedValue) == 57 || Convert.ToInt32(curId.SelectedValue) == 58 || Convert.ToInt32(curId.SelectedValue) == 59)) //Si es Jardin Padre Victor Sala 3
                                {
                                    NomRep = "InformeConstanciaPreinscripcionPadreVictor.rpt";
                                }
                                else
                                {
                                    if (insId == 5 && (Convert.ToInt32(curId.SelectedValue) == 60 || Convert.ToInt32(curId.SelectedValue) == 61 || Convert.ToInt32(curId.SelectedValue) == 62 || Convert.ToInt32(curId.SelectedValue) == 63)) //Si es Jardin Padre Victor Sala 4
                                    {
                                        NomRep = "InformeConstanciaPreinscripcionPadreVictor.rpt";
                                    }
                                    else
                                    {
                                        if (insId == 5 && (Convert.ToInt32(curId.SelectedValue) == 60 || Convert.ToInt32(curId.SelectedValue) == 61 || Convert.ToInt32(curId.SelectedValue) == 62 || Convert.ToInt32(curId.SelectedValue) == 63)) //Si es Jardin Padre Victor Sala 5
                                        {
                                            NomRep = "InformeConstanciaPreinscripcionPadreVictor.rpt";
                                        }
                                    }
        ...
        if (NomRep != "")
        {
            FuncionesUtiles.AbreVentana("Reporte.aspx?aluId=" + alumnoId + "&curso=" + curso + "&anio=" + anio + "&NomRep=" + NomRep);
        }
        

    }

    protected void btnNuevaPreInscripcion_Click(object sender, EventArgs e)
    {
        alerErrorConcepto.Visible = false;
        alerEdad.Visible = false;
        aluFechaNacimiento.Text = "";
        alerConceptoyaRegistrado.Visible = false;
        lblicuId.Text = "";
        lblicoId.Text = "";
        aluNombre.Text = "";
    ...
    protected void btnAgregar_Click(object sender, EventArgs e)
    {
        ...
        int Bandera = 0;
        int Id = 0;
        if (Convert.ToInt32(curId.SelectedValue) == 60 || Convert.ToInt32(curId.SelectedValue) == 61 || Convert.ToInt32(curId.SelectedValue) == 62 || Convert.ToInt32(curId.SelectedValue) == 63 ||  
            Convert.ToInt32(curId.SelectedValue) == 68 || Convert.ToInt32(curId.SelectedValue) == 77 || Convert.ToInt32(curId.SelectedValue) == 81 || Convert.ToInt32(curId.SelectedValue) == 118 ||
            Convert.ToInt32(curId.SelectedValue) == 56 || Convert.ToInt32(curId.SelectedValue) == 57 || Convert.ToInt32(curId.SelectedValue) == 58 || Convert.ToInt32(curId.SelectedValue) == 59 || 
            Convert.ToInt32(curId.SelectedValue) == 60 || Convert.ToInt32(curId.SelectedValue) == 61 || Convert.ToInt32(curId.SelectedValue) == 62 || Convert.ToInt32(curId.SelectedValue) == 63 || 
            Convert.ToInt32(curId.SelectedValue) == 171 || Convert.ToInt32(curId.SelectedValue) == 172 || Convert.ToInt32(curId.SelectedValue) == 173 || Convert.ToInt32(curId.SelectedValue) == 174)
        {
            Bandera = 1;
            DateTime limite;
            ///////////// Calculo edad  ///////////////////////
            if (Convert.ToInt32(curId.SelectedValue) == 60 || Convert.ToInt32(curId.SelectedValue) == 61 || Convert.ToInt32(curId.SelectedValue) == 62 || Convert.ToInt32(curId.SelectedValue) == 63 || Convert.ToInt32(curId.SelectedValue) == 171 || Convert.ToInt32(curId.SelectedValue) == 172 || Convert.ToInt32(curId.SelectedValue) == 173 || Convert.ToInt32(curId.SelectedValue) == 174)// Salita de 4 y 5
            {
                limite = new DateTime(DateTime.Today.Year + 1, 06, 30); //fecha Limite
            }
            else
            {
                limite = new DateTime(DateTime.Today.Year + 1, 06, 29); //fecha Limite
            }

            DateTime nacimiento = Convert.ToDateTime(aluFechaNacimiento.Text); //Fecha de nacimiento
            int edad = limite.AddTicks(-nacimiento.Ticks).Year - 1;  //- 1
            if (Convert.ToInt32(curId.SelectedValue) == 68 || Convert.ToInt32(curId.SelectedValue) == 77 || Convert.ToInt32(curId.SelectedValue) == 81 || Convert.ToInt32(curId.SelectedValue) == 118) //1 grado
            {
                if (edad >= 6 & edad <= 7)
                {
                    Bandera = 0;
            ...
            {
                if (Convert.ToInt32(curId.SelectedValue) == 56 || Convert.ToInt32(curId.SelectedValue) == 57 || Convert.ToInt32(curId.SelectedValue) == 58 || Convert.ToInt32(curId.SelectedValue) == 59) //Salita de 3
                {
                    if (edad >= 3 & edad <= 4)
                    {
                        Bandera = 0;
                ...
                {
                    if (Convert.ToInt32(curId.SelectedValue) == 60 || Convert.ToInt32(curId.SelectedValue) == 61 || Convert.ToInt32(curId.SelectedValue) == 62 || Convert.ToInt32(curId.SelectedValue) == 63)// Salita de 4
                    {
                        if (edad >= 4 & edad <= 5)    // Probar con 30/06 no permite
                        {
                            Bandera = 0;
                        }
                    }
                    ...
                    {
                        if (Convert.ToInt32(curId.SelectedValue) == 171 || Convert.ToInt32(curId.SelectedValue) == 172 || Convert.ToInt32(curId.SelectedValue) == 173 || Convert.ToInt32(curId.SelectedValue) == 174)// Salita de 5
                        {
                            if (edad >= 5 & edad <= 6)  // Probar con 30/06 no permite
                            {
                                Bandera = 0;
                            }
                        }
        ...
        if (Bandera == 0)// dentro de la edad segun curso..
        {
            ...
            dtN.Columns.Add("Id", typeof(Int32));
            dtN.Columns.Add("conId", typeof(Int32));
            dtN.Columns.Add("cntId", typeof(Int32));
            dtN.Columns.Add("TipoConcepto", typeof(String));
            dtN.Columns.Add("Concepto", typeof(String));
            dtN.Columns.Add("Importe", typeof(Decimal));
            dtN.Columns.Add("Beca", typeof(String));
            dtN.Columns.Add("BecId", typeof(Int32));
            dtN.Columns.Add("NroCuota", typeof(Int32));
            dtN.Columns.Add("AnioLectivo", typeof(Int32));
            dtN.Columns.Add("FchInscripcion", typeof(string));
            GrillaConcepto.DataSource = dtN;
            GrillaConcepto.DataBind();
            Session["Datos"] = dtN;

            if (GrillaConcepto.Rows.Count == 0)
            {
                try
                {
                    insId = Convert.ToInt32(Session["_Institucion"]);
                            ...
                            if (ConTipoId.SelectedValue == "4")
                            {
                                if (dt.Rows.Count > 0)//chequeo que no haya ingresado ese concepto en la tabla..
                                {
                                    foreach (DataRow row in dt.Rows)
                                    {
                                        if (Convert.ToInt32(row["Id"].ToString()) == 1)
                                        {
                                            if ((Convert.ToInt32(row["cntId"].ToString()) == 4))
                                            {
                                                Estado = 1;
                                            }
                                        }
    ...
    protected void NivelID_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (Convert.ToInt32(dt.Rows[0]["SinPC"].ToString()) == 0)//TIENE CARRERA Y PLAN? 0=SUPERIOR
        {
            ...
            if (dt2.Rows.Count > 0)
            {
                ...
                carId.DataSource = (new GESTIONESCOLAR.Negocio.Carrera()).ObtenerListaParaPreInscripcion("[Seleccionar...]", Convert.ToInt32(NivelID.SelectedValue));
                carId.DataBind();
