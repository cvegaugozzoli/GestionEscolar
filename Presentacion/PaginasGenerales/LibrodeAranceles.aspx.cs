...
public partial class LibrodeAranceles : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                this.Master.TituloDelFormulario = " Libro de Aranceles";
    ...
    private void GrillaCargar2(int PageIndex)
    {
        try
        {
            ...
            else
            {
                ...
                if (Convert.ToInt32(RbtSeleccion.SelectedValue) == 1)
                {
                    NomRep2 = "LibrodeArancelesNivelTodos.rpt";
                }
                else
                {
                    NomRep2 = "LibrodeArancelesNivelTodosxBeca.rpt";
                }
...
MESSAGE:<br>" + oError.Message + "<br><br>EXCEPTION:<br>" + oError.InnerException + "<br><br>TRACE:<br>" + oError.StackTrace + "<br><br>TARGET:<br>" + oError.TargetSite +
    ...
    protected void btnImprimir_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Convert.ToInt32(RbtSeleccion.SelectedValue) == 1)
            {
                NomRep = "LibrodeAranceles.rpt";
            }
            else
            {
                NomRep = "LibrodeArancelesBecados.rpt";
            }
            ...
            //String empcuit = "20216312547";
            //String NomRep22 = "ReciboSueldo.rpt";
            //FuncionesUtiles.AbreVentana("Reporte.aspx?empcuit=" + empcuit + "&NomRep=" + NomRep22);
        }
        catch (Exception oError)
        {
            lblMensajeError.Text = @"<div class=""alert alert-danger alert-dismissable"">
