<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="LlamadosExamenConsulta.aspx.cs" Inherits="LlamadosExamenConsulta" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
    ...
    <div class="row">
	    <div class="col-sm-12">
		    ...
		    <div class="ibox-content">
                <div class="table-responsive"><asp:GridView ID="Grilla" runat="server" CssClass="table table-striped"
	                ...
	                <Columns>
                        ...
                        <asp:TemplateField HeaderText="Id" Visible="false">
                            <ItemTemplate>
                                <asp:HyperLink ForeColor="Black" ID="Id" runat="server" NavigateUrl='<%# "LlamadosExamenRegistracion.aspx?Id=" + DataBinder.Eval(Container.DataItem,"Id").ToString() %>' Text='<%# Eval("Id") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
 
                        <asp:TemplateField HeaderText="Nombre">
                            <ItemTemplate>
                                <asp:HyperLink ForeColor="Black" ID="Nombre" runat="server" NavigateUrl='<%# "LlamadosExamenRegistracion.aspx?Id=" + DataBinder.Eval(Container.DataItem,"Id").ToString() %>' Text='<%# Eval("Nombre") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>                   
                          <asp:TemplateField HeaderText="Tipo Examen">
                            <ItemTemplate>
                                <asp:HyperLink ForeColor="Black" ID="extNombre" runat="server" NavigateUrl='<%# "LlamadosExamenRegistracion.aspx?Id=" + DataBinder.Eval(Container.DataItem,"Id").ToString() %>' Text='<%# Eval("extNombre") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>    
                        <asp:TemplateField HeaderText="Activo">
                            <ItemTemplate>
                                <asp:HyperLink ForeColor="Black" ID="Activo" runat="server" NavigateUrl='<%# "LlamadosExamenRegistracion.aspx?Id=" + DataBinder.Eval(Container.DataItem,"Id").ToString() %>' Text='<%# Eval("Activo") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
