...
<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-check mt-2">
                                    <asp:CheckBox ID="chkAplicarAnio" AutoPostBack="true" runat="server" CssClass="form-check-input" OnCheckedChanged="chkAplicarAnio_CheckedChanged1" />
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-check form-check-inline">
                                    <asp:RadioButton ID="rbDni" AutoPostBack="true" runat="server" GroupName="BuscarPor" CssClass="form-check-input" OnCheckedChanged="rbDni_CheckedChanged1" />
    ...
    ⚠️ <u>Importante</u>:  Una vez cargadas las nota debe confirmar las mismas con el botón Guardar Notas<br /> </p>                            </div>  <div class="col-md-2">
                                <br/>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:Panel ID="pnlContents" runat="server">
                                        <asp:GridView ID="GrillaNota" runat="server" CssClass="table table-striped" AutoGenerateColumns="False"
                                            OnRowDataBound="GrillaNota_RowDataBound"
                                            Width="100%" DataKeyNames="Id,FDictado,Asignatura" PageSize="50" AllowPaging="True" OnRowUpdating="OnRowUpdating"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Eval. Final" ItemStyle-Width="100">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtPAnual" runat="server" Text='<%# Eval("PAnual") %>' Width="90"></asp:TextBox>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText=" Rec. Dic." ItemStyle-Width="100">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Rec. Mar." ItemStyle-Width="100">
                                                    <ItemTemplate>
