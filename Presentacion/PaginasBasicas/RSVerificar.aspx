<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RSVerificar.aspx.cs" Inherits="RSVerificar" %>
    ...
    <div class="container-contact100">
        <div class="wrap-contact100">
            <form runat="server" class="contact100-form validate-form">
                ...
                <span class="contact100-form-title">Validación de Recibo de Haberes
                </span>
                ...
                <div class="wrap-input100">
                    <asp:TextBox ID="txtEstado" class="input100" runat="server" BackColor ="Blue" Font-Bold="true" ForeColor ="White" ></asp:TextBox>
                    <span class="focus-input100"></span>
                </div>

                <label class="label-input100" for="first-name">Empleado</label>
                <div class="wrap-input100">
                    <asp:TextBox ID="txtNombre" class="input100" Enabled ="false"  runat="server"></asp:TextBox>
                    <span class="focus-input100"></span>
                </div>
                <label class="label-input100">CUIL</label>
                <div class="wrap-input100">
                    <asp:TextBox ID="txtCUIL" class="input100" Enabled ="false" runat="server"></asp:TextBox>
                    <span class="focus-input100"></span>
                </div>
                <label class="label-input100">Liquidación</label>
                <div class="wrap-input100">
                    <asp:TextBox ID="txtliquidacion" class="input100" Enabled ="false" runat="server"></asp:TextBox>
                    <span class="focus-input100"></span>
                </div>
            ...
            <div class="contact100-more flex-col-c-m" style="color: #FFFFFF">
                ...
                <div class="dis-flex size1 p-b-47">
                    ...
                    <div class="flex-col size2">
                        ...
                        <br />
                        <span class="txt1">ESCUELA SAN VICENTE</span>
                        <br />
                    </div>
                </div>
            </div>
