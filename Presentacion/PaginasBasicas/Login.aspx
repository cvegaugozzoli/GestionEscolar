...
<body class="gray-bg" background="../Imagenes/FondoPrincipal.jpg">
    <form id="form1" runat="server">
        <div class="middle-box text-center loginscreen animated fadeInDown">
            ...
            <div class="form-group">
                ...
                <asp:DropDownList ID="PerfilId" Visible="false" runat="server" BorderColor="Silver" class="form-control m-b" Enabled="true" AutoPostBack="True"  AppendDataBoundItems="true" OnSelectedIndexChanged="PerfilId_SelectedIndexChanged"></asp:DropDownList>
                    <%--OnSelectedIndexChanged="PerfilId_SelectedIndexChanged"--%>
            </div>
            ...
            <div>
                ...
                <asp:Label ID="lblPerfil" runat="server" Text="Debe seleccionar una Perfil"
                    Visible="False" CssClass="nuevoEstilo3"></asp:Label>
            </div>
            <div>
    ...
    <div>
                <asp:Label ID="lblErrorPerfil" runat="server" Text="Perfil no pertenece a ese Usuario"
                    Visible="False" CssClass="nuevoEstilo3"></asp:Label>
            </div>
        </div>
