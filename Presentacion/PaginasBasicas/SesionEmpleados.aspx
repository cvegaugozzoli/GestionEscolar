<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SesionEmpleados.aspx.cs" Inherits="SesionEmpleados" %>
...
<body class="gray-bg" background="../Imagenes/FondoPrincipalEmpleados.jpg">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            ...
            <br />
            <a href="InicioEmpleados.aspx" class="btn btn-primary" target="_blank">Ingresar</a>
            <a href="CerrarSesionEmpleados.aspx" class="btn btn-primary">Cerrar Sesion</a>
        </div>
    </div>
    <!-- Mainly scripts -->
