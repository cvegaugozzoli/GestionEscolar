...
namespace GESTIONESCOLAR
{
    namespace Negocio
    {
        public partial class  Docentes
        {
            ...
            public Docentes(Int32 doc_id, String doc_doc, String doc_nombre, String doc_apellido, String doc_domicilio, String doc_telef, String doc_mail, Int32 usu_id, DateTime docFechaHoraCreacion, DateTime docFechaHoraUltimaModificacion, Int32 IusuidCreacion, Int32 IusuidUltimaModificacion)
			{
                try
                {
				    this.doc_id = doc_id;
            ...
            public void Insertar(String doc_doc, String doc_nombre, String doc_apellido, String doc_domicilio, String doc_telef, String doc_mail, Int32 usu_id, Int32 usuidCreacion, Int32 usuidUltimaModificacion, DateTime docFechaHoraCreacion, DateTime docFechaHoraUltimaModificacion)
            {
                try
                {
