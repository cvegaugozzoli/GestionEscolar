                ...
                <div class="table-responsive"><asp:GridView ID="Grilla" runat="server" GridLines="None" CssClass="table table-striped"
	                ...
	                <Columns>
                        ...
                        <asp:TemplateField HeaderText="Usuario">
                            <ItemTemplate>
                                <asp:HyperLink ForeColor="Black" ID="Usuario" runat="server" NavigateUrl='<%# "UsuarioEspacioCurricularRegistracion.aspx?Id=" + DataBinder.Eval(Container.DataItem,"Id").ToString() %>' Text='<%# Eval("Usuario") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
